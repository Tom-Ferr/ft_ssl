...
static uint64_t* init_buffers(void)
{
    ...
    buffers[0] = 0x8C3D37C819544DA2;
    buffers[1] = 0x73E1996689DCD4D6;
    buffers[2] = 0x1DFAB7AE32FF9C82;
    buffers[3] = 0x679DD514582F9FCF;
    buffers[4] = 0x0F6D2B697BD44DA8;
    buffers[5] = 0x77E36F7304C48942;
    buffers[6] = 0x3F9D85A86A1D36C8;
    buffers[7] = 0x1112E6AD91D692A1;

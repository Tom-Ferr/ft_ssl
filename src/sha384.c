...
static uint64_t* init_buffers(void)
{
    ...
    buffers[0] = 0xcbbb9d5dc1059ed8;
    buffers[1] = 0x629a292a367cd507;
    buffers[2] = 0x9159015a3070dd17;
    buffers[3] = 0x152fecd8f70e5939;
    buffers[4] = 0x67332667ffc00b31;
    buffers[5] = 0x8eb44a8768581511;
    buffers[6] = 0xdb0c2e0d64f98fa7;
    buffers[7] = 0x47b5481dbefa4fa4;
